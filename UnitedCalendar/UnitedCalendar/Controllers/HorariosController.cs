...
namespace UnitedCalendar.Controllers
{
    public class HorariosController : Controller
    {
        ...
        public HorariosController(UnitedDB context)
        {
            _context = context;
        }
        ...
        {
            var unitedDB = _context.Horario.Include(h => h.IdUserNavigation);
        ...
        public async Task<IActionResult> Create([Bind("Id,IdUser,Publico")] Horario horario)
        {
            ...
            ViewData["IdUser"] = new SelectList(_context.User, "Id", "Email", horario.IdUser);
            return View(horario);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdUser,Publico")] Horario horario)
        {
            if (id != horario.Id)
            {
                return NotFound();
